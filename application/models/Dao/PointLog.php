 ...
 * @author ducdm
 */
class Dao_PointLog extends Qsoft_Db_Table_Abstract implements Dao_Interface_EntityAccessable
{

    protected $_name = 'point_log';
    
    protected $_rowClass = 'Dto_PointLog';    
    ...
    {          
        if ( ! $select instanceof Zend_Db_Select) {
			$select = $this->select()
                           ...
                           ->joinLeft('user', $this->_name.'.user_id = user.id', array('unique_id', 'user.user_id AS user_id_text'))                           
