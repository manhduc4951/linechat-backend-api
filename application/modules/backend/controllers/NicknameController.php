...
class NicknameController extends Qsoft_Controller_Backend_Action
{ 
    protected $_daoClass = 'Dao_NickName'; 
    
    protected $_formClass = 'Form_Nickname';
    ...
    public function deleteAction()
    {
        ...
        $nicknameDto = $this->getDao()->fetchOneBy('id', $id);
        if($this->getDao()->delete($nicknameDto))
        {
