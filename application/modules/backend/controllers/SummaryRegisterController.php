...
class SummaryRegisterController extends Qsoft_Controller_Backend_Action
{ 
    protected $_daoClass = 'Dao_SummaryRegister';     
    
    protected $_filterClass = 'Filter_SummaryRegister';    
